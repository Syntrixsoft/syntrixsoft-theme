...
(function () {
  ...
  const NexusIT = {
    ...
    preloader() {
      ...
      const finish = () => {
        ...
        requestAnimationFrame(() => {
          requestAnimationFrame(() => {
            window.dispatchEvent(new Event("nexusit:loaded"));
          });
        });
      };
    ...
    themeToggle() {
      ...
      const saved = localStorage.getItem("nexusit-theme");
      ...
      toggle.addEventListener("click", () => {
        ...
        if (next === "dark") {
          ...
          localStorage.setItem("nexusit-theme", "dark");
        } else {
          document.documentElement.setAttribute("data-theme", "light");
          localStorage.setItem("nexusit-theme", "light");
        }
      });
    },
